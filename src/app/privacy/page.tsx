...
export const metadata = {
  ...
  description: "How Gyantex Enterprise collects, uses, and protects order information.",
};
...
export default function PrivacyPage() {
  return (
    <StaticPageLayout title="Privacy Policy">
      <p>
        This explains what information <strong>{LEGAL_ENTITY_NAME}</strong> collects when you place an order, track an order,
        or contact us. We collect only what we need to process, fulfill, and support your order.
      </p>
      ...
      <ul>
        ...
        <li>The products, options, quantity, and delivery choice in your order</li>
      ...
      <p>
        ...
        partners, and Gyantex staff working on your order. We do not sell customer information.
      </p>
